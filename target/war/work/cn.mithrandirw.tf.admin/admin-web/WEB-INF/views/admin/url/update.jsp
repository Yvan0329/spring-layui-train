...
<html>
	...
	<body>
					...
					<form id="createForm" class="form-horizontal">
						<input type="hidden" name="id" value="${entity.id}" />
					  	<div class="form-group form-group-first">
							...
							<div class="col-sm-8">
					  			<input type="text" class="form-control" id="url" name="url" value="${entity.url}"
									   placeholder="请输入URL地址(必填)" required maxlength="1024"
									remote="${ctx}/admin/sys-url/exist?property=url&id=${entity.id}" />
							</div>
					  	</div>
		...
		<script type="text/javascript">
			changeTitle('修改资源');
			$(function() {
                initForm('#createForm', '${ctx}/admin/sys-url/update',
                    function(json) {
